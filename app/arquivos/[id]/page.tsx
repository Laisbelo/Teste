    ...
    return(
        <div className="w-screen h-screen">
            ...
            <div className="p-10 w-full gap-8 h-full flex flex-col align-middle justify-center">
                <div className="w-full text-center text-4xl text-slate-700">
                    <h1 >
                        {titulo}
                    </h1>
                </div>
                ...
                <div className="flex justify-center">
                    <a href={`/arquivos`}className="inline-flex w-1/2 flex justify-center px-4 py-2 text-white bg-blue-500 rounded-lg active hover:bg-blue-300" aria-current="page">
                        Voltar
                    </a>
                </div>
            </div>
